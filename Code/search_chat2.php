...
<br><br>
<form method="GET" action="search_chat2.php">
...
echo" <tr>
    ...
    <td>$clinic</td>
    <td>$specialist</td>
<td><form method=\"POST\" action=\"search_chat2.php\"><input type=\"submit\" name=\"$id\" value=\"Send MRI\"onClick=\"document.location.reload(true)\">
	</td>
	</tr>";
...
echo ' <script language="javascript" type="text/javascript">
alert("Now you can submit MRI Scan to doctor ");
parent.document.location="mri.php";
</script>';
